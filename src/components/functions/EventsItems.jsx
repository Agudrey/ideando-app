import evento_experiencial from "../Images/images-events/Eventos-Experienciales.webp"
import evento_integracion from "../Images/images-events/Eventos-de-Integracion.webp"
...
import evento_aniversario from "../Images/images-events/Aniversarios-de-Empresas.webp"
import evento_seminario from "../Images/images-events/Seminarios-Congresos-simposios.webp"
import evento_coctel from "../Images/images-events/Coctel.webp"


export const EventsItems = [
  {
    id: 1,
    image: evento_experiencial,
    name: 'Eventos Experienciales',
    description: 'Creamos una estrategia a nivel empresarial que consiste en fidelizar a potenciales clientes y/o consumidores mediante la organización de eventos que canalicen las sensaciones y experiencias de los asistentes. Nuestro objetivo con estos acontecimientos es que los participantes no los olviden con facilidad y  queden en su memoria, potenciando así el reconocimiento de la marca.'
  },
  {
    id: 2,
  ...
  {
    id: 4,
    image: evento_cultural,
    name: 'Eventos culturales y/o Recreativos',
    description: 'Estos eventos tienen como finalidad difundir e incentivar el  esparcimiento de diferentes actividades que lograran crear vínculos emocionales con el público asistente. Estos pueden hacer referencia a las artes escénicas, musicales, fotografía, literatura, ferias, conciertos. Generalmente se organizan jornadas para una temática en particular.'  
  },
  {
    id: 5,
  ...
  {
    id: 9,
    image: evento_lanzamiento_producto,
    name: 'Lanzamientos de Producto',
    description: 'Tiene como objetivo que el producto o marca que se dé a conocer perdure en la mente de los asistentes antes durante y después del evento. En Ideando Eventos y Marketing creamos una estrategia específica para ti y nos encargamos de organizar el evento con todos los servicios requeridos para la logística con la mejor planificación, comunicación y ejecución.'  
  },
  {
    id: 10,
  ...
  },
  {
    ...
    description: 'Buscamos principalmente que el espacio sea el más adecuado para este tipo de eventos porque sabemos que es un acontecimiento muy importante a celebrar o dar a conocer. Queremos que los asistentes experimenten la calidad de nuestros servicios como el catering, el personal y la producción audiovisual sin perder el objetivo de la creación del espacio planeado por la empresa.'  
  },
]
